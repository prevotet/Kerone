...
C_SRCS += \
../src/App/port/mibench_susan/susan.c 

OBJS += \
./src/App/port/mibench_susan/susan.o 

C_DEPS += \
./src/App/port/mibench_susan/susan.d 


# Each subdirectory must supply rules for building sources it contributes
src/App/port/mibench_susan/%.o: ../src/App/port/mibench_susan/%.c
	@echo 'Building file: $<'
