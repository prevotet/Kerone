...
*               the following exception vectors.
*
...
/*
*********************************************************************************************************
*                     ARM CORTEX-A9 PROGRAM STATUS REGISTER BIT & BIT-FIELDS DEFINES
*********************************************************************************************************
*/
...
/*
*********************************************************************************************************
*                          ARM CORTEX-A9 EVENTS AND PERFORMANCE MONITOR
*
...
#define  CPU_ARM_EVENT_INST_EXECUTED                   0x08u    /* Instruction architecturally executed.                */
...
#define  CPU_ARM_EVENT_EXT_MEM_REQ                     0x43u    /* External Memory request.                             */

#define  CPU_ARM_EVENT_LSU_STALL_BUSY                  0x44u    /* Stall because of LSU being busy.                     */
...
#define  CPU_ARM_EVENT_FIQ_INT_DIS                     0x46u    /* The number of cycles FIQ interrupts are disabled.    */
#define  CPU_ARM_EVENT_IRQ_INT_DIS                     0x47u    /* The number of cycles IRQ interrupts are disabled.    */
...
/*
*********************************************************************************************************
*                             ARM CORTEX-A9 MEMORY PROTECTION UNIT DEFINES
*********************************************************************************************************
*/
