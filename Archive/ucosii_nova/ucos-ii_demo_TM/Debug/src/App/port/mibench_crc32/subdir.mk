...
C_SRCS += \
../src/App/port/mibench_crc32/crc_32.c 

OBJS += \
./src/App/port/mibench_crc32/crc_32.o 

C_DEPS += \
./src/App/port/mibench_crc32/crc_32.d 


# Each subdirectory must supply rules for building sources it contributes
src/App/port/mibench_crc32/%.o: ../src/App/port/mibench_crc32/%.c
	@echo 'Building file: $<'
